...
### Import post_processing module to access rotation matrix function
import post_process
    ...
    def sim(self, aircraft_properties, nonlinear_parameters, simulation_parameters):
        ...
        for idx, t in enumerate(rng):
            ...
            if idx < len(rng)-1:
                ...
                # angular translation relative to earth
                ...
                ''' Update location relative to earth surface '''
                u, v, w = post_process.rot_vec(self.phi, self.theta, self.psi)
                xe[idx+1] = xe[idx] + V[idx]*u
                ye[idx+1] = ye[idx] + V[idx]*v
                ze[idx+1] = ze[idx] + V[idx]*w
